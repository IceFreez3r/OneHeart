...
execute as @a[gamemode=survival,scores={SurviveOnSpawner=1..}] at @s unless block ~ ~-1 ~ spawner run scoreboard players set @s SurviveOnSpawner 0
execute as @a[gamemode=survival,scores={SurviveOnSpawner=1..}] at @s run function oneheart:blocks/spawner/faster
