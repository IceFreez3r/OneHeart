...
execute as @a[advancements={oneheart:shoot_arrow=false}] if score @s UUID0 = %arrow UUID0 if score @s UUID1 = %arrow UUID1 if score @s UUID2 = %arrow UUID2 if score @s UUID3 = %arrow UUID3 run advancement grant @s only oneheart:shoot_arrow
