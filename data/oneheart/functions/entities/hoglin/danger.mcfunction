...
execute if score @s SummonHoglin matches 1..20 run title @s actionbar {"translate":"actionbar.oneheart.hoglin.teaser"}
execute if score @s SummonHoglin matches 1..20 run playsound entity.hoglin.ambient hostile @s
execute if score @s SummonHoglin matches 21..40 run title @s actionbar {"translate":"actionbar.oneheart.hoglin.warning"}
execute if score @s SummonHoglin matches 21..40 run playsound entity.hoglin.angry hostile @s
execute if score @s SummonHoglin matches 41..60 run title @s actionbar {"translate":"actionbar.oneheart.hoglin.danger"}
